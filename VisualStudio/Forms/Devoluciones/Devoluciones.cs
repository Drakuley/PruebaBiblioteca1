...
namespace PruebaBiblioteca1.Forms.Devoluciones
{
    public partial class Devoluciones : Form
    {
        ...
        public Devoluciones(int idPrestamos, FrmMenú f1)
        {
            InitializeComponent();
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'prestamosDevoluciones1.Devoluciones' Puede moverla o quitarla según sea necesario.
            //this.devolucionesTableAdapter.Fill(this.prestamosDevoluciones1.Devoluciones);
        ...
        private void TxtBusqueda_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtBusqueda.Text != "")
            {
                this.dataTable1TableAdapter.fillBusquedaDevolucionPrestamoAdquisicion(this.prestamosDevoluciones1.DataTable1, txtBusqueda.Text);
            }
            else
            {
                this.dataTable1TableAdapter.FillBy1(this.prestamosDevoluciones1.DataTable1);
