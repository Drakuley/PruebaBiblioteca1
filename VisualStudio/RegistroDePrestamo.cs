...
namespace Biblioteca4
{
    public partial class RegistroDePrestamo : Form
    {
        ...
        public RegistroDePrestamo(Form1 f1)
        {
            InitializeComponent();
            estatus = 0;
            frm1 = f1;
        ...
        public RegistroDePrestamo(int prestamo, Form1 f1)
        {
            InitializeComponent();
            idPrestamo = prestamo;
            estatus = 1;
        ...
        {
            //new FormStartPosition.FrmLibros().Show();
            //this.Hide();
        }

        private void BtnUsuario_Click(object sender, EventArgs e)
        {
            //new FormStartPosition.frmUsuarios().Show();
            //this.Hide();
        }
