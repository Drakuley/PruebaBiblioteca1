...
//            fechaFin = DateTime.Now.ToString("dd/MMMM/yyyy");
        }
        ...
        private void BtnGenerarReporte_Click(object sender, EventArgs e)
        {
            ...
            new ReporteDevoluciones(iDate.ToString("yyyy/MM/dd"), oDate.ToString("yyyy/MM/dd")).Show();
        ...
        private void GenerarReporteDevoluciones_Load(object sender, EventArgs e)
        {
            if (txtFechaInicio.Text == "")
            {
                btnGenerarReporte.Enabled = false;
